...
```javascript
import regexp2json from 'https://cdn.jsdelivr.net/gh/stdlib-js/regexp-to-json@v0.2.0-deno/mod.js';
```
...
[@stdlib/regexp/reviver]: https://github.com/stdlib-js/regexp-reviver/tree/deno
